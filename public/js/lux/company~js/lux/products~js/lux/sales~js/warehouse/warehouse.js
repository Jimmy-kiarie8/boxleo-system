(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["js/lux/company~js/lux/products~js/lux/sales~js/warehouse/warehouse"],{
  ...
  created: function created() {
    ...
    eventBus.$on("ApiConnectEvent", function (data) {
      ...
      if (data.value == 'google_sheets') {
        _this.get_json();
      } else if (data.value == 'twilio' || data.value == 'africas_talking') {
        _this.getApi(0);
      }
