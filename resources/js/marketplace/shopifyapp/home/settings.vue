...
<v-dialog v-model="dialog" persistent max-width="600px" transition="dialog-transition">
    <v-card elevation="3">
        ...
        <v-card-text>
            ...
            <el-select v-model="form.ou_id" filterable reserve-keyword placeholder="Operating unit" style="width: 100%;">
            ...
            <div v-if="form.sync_option == 'Auto'">
...
export default {
    ...
    created() {
        eventBus.$on('settingsEvent', data => {
