        ...
        <div v-if="orders.sales.length > 0">
            ...
            <v-card>
                ...
                <v-data-table :headers="headers" :items="orders.sales" :search="search" :item-class="itemRowBackground">
                    <!-- <div :style="[ (!order.product.id || !order.entry.order_id || !order.entry.quantity || !order.entry.address || !order.entry.client_name || !order.entry.phone) ? {'background': '#ff00008a'} : '']"> -->
                        ...
                        <template v-slot:item.entry.client_name="{ item }">
                            <el-input placeholder="Please input" v-model="item.entry.client_name"></el-input>
                        </template>
                        ...
                        <template v-slot:item.entry.special_instructions="{ item }">
                            <el-input type="textarea" autosize placeholder="Please input" v-model="item.entry.special_instructions"></el-input>
                        </template>
