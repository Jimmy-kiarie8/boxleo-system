    ...
    <v-stepper v-model="e1">
        ...
        <v-stepper-items>
            ...
            <v-stepper-content step="2">
                <div v-if="e1 == 2">
                    <myDisplay :product_upload="product_upload" />
                    <v-btn color="red" style="text-transform: none;color: #fff;" rounded @click="importProducts" :disabled="!validate" v-if="product_upload.length > 0">
