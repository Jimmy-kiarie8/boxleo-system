                ...
                <el-tabs :tab-position="tabPosition" style="width: 80%;">
                    <el-tab-pane label="Overview">
                        <div style="text-align: center">
                            ...
                            <address></address>
                            <p>
                                <v-icon>mdi-map-marker</v-icon> {{ company.address }}, {{ company.ou }}
                            </p>
                            <p> {{ company.about }}</p>
                        </div>
                    </el-tab-pane>
                    ...
                    <el-tab-pane label="API Connection">
                        <myApiIntegration />
                    </el-tab-pane>
                </el-tabs>
            </v-card>
...
import myApiIntegration from './apis'
import {
    mapState
} from 'vuex';
export default {
    ...
    computed: {
        ...
        company_logo() {
            ...
            return this.company.logo ? this.company.logo : " /images/upload.png";
        },
