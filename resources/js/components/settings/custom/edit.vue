        ...
        <v-layout justify-center align-center wrap>
            ...
            <v-flex sm12>
                <v-card>
                    ...
                    <h3>Define the criteria ( if any )</h3>
                        ...
                        <v-flex sm2 v-if="items.condition">
                            <div v-if="form.conditions.length > 0">
                                ...
                                <div v-else-if="form.conditions[index]['row']['Default'] == 'Inprogress'">
                                    <el-select filterable clearable v-model="items.value" placeholder="Select" v-if="form.conditions[index]['row']['Field'] == 'status'">
                    ...
                    <v-btn small text color="primary" @click="add_row">
                    ...
                    <v-layout row wrap>
                        <v-flex sm3 style="margin-left: 30px">
                            <v-card>
                                ...
                                <v-card-text style="max-height: 300px; overflow-y: scroll !important;">
                                    <draggable class="dragArea list-group" :list="available_rows" :clone="clone" :group="{ name: 'people', pull: pullFunction }" @start="start">
                                        <div class="list-group-item" v-for="(element, index) in available_rows" :key="index">
                                            {{ element.label }}<v-icon style="float: right">mdi-drag</v-icon>
                                        </div>
                                    </draggable>
                                </v-card-text>
                            </v-card>
    ...
    methods: {
        ...
        getCustoms() {
            ...
            this.$store.dispatch("showItem", payload).then((response) => {
                ...
                this.form.selected_columns = response.data.columns
            })
        },
    },
    computed: {
