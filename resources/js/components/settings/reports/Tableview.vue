...
<v-card style="width: 100%; padding: 0 20px">
    ...
    <v-chip-group mandatory v-if="report === 'Remitance'">
    ...
    <v-data-table :headers="headers" :items="(report === 'Remitance') ? sales.sales : sales.sales.data" :search="search" :loading="loading">
