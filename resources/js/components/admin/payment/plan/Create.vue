            ...
            <v-card-text>
                <v-container grid-list-md>
                    <v-layout row wrap>
                        ...
                        <v-flex sm6>
                            <label for="">Automated Workflows</label>
                        ...
                        <v-flex sm6>
                            <label for="">Operating Units</label>
                        ...
                        <v-flex sm6>
                            ...
                            <el-input placeholder="" v-model="form.emails"></el-input>
                            <small class="has-text-danger" v-if="errors.emails">{{ errors.emails[0] }}</small>
                        </v-flex>
                        <v-flex sm6>
                            <el-checkbox-group v-model="form.checkList">
                                <el-checkbox label="Warehouse management"></el-checkbox>
                                <el-checkbox label="Inventory management"></el-checkbox>
...
export default {
    ...
    created() {
        eventBus.$on("openCreatePlan", data => {
            this.dialog = true;
        });
    },
