...
<v-card style="overflow-x: hidden;">
    ...
    <v-container grid-list-md>
        <v-card-text>
            <v-layout wrap>
                <el-upload class="upload-demo" drag action="/get_users" :auto-upload="false" :data="form" ref="upload" :headers="headers" :on-success="handleSuccess" :on-error="handleError" :before-upload="beforeUpload">
                ...
                <!-- <input type="file" @change="GetUsers" style="display: none" ref="fileInput"> -->
...
export default {
    ...
    methods: {
        ...
        handleSuccess(res, file) {
            ...
            eventBus.$emit('userResponseEvent', res)
            this.users_upload = res
        },
