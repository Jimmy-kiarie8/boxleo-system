<template>
<el-tabs v-model="activeName" @tab-click="handleClick" style="width: 90%;margin: auto;">
                    ...
                    <v-layout row wrap>
                        ...
                        <v-flex sm10>
                            ...
                            <span>
                                ...
                                <small>Sales order has been created. You can email the Sales Order to your customer or mark it as Confirmed.</small>
                            </span>
                        </v-flex>
                    </v-layout>
                </div>
