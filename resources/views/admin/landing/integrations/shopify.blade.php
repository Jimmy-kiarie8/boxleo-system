...
@section('title', 'Shopify Order Management | Logixsaas + Shopify Integration')
@section('description', 'Power up your Shopify order management with Logixsaas. Enjoy seamless integration with your clients store. Manage orders, shipping and much more.')
@section('og:title','Shopify Order Management | Logixsaas + Shopify Integration')
@section('og:description',"Power up your Shopify order management with Logixsaas. Enjoy seamless integration with your clients store. Manage orders, shipping and much more.")
@section('twitter:title','Shopify Order Management | Logixsaas + Shopify Integration')
@section('twitter:description',"Power up your Shopify order management with Logixsaas. Enjoy seamless integration with your clients store. Manage orders, shipping and much more.")
@section('url', 'shopify')
    ...
    <section class="page-banner">
        <div class="container">
            <div class="page-title-wrapper">
                <h1 class="page-title">Shopify</h1>
                ...
                <div class="col-lg-7">
                    <div class="about-content">
                        ...
                        <p class="description wow pixFadeUp" data-wow-delay="0.4s" style="visibility: visible; animation-delay: 0.4s; animation-name: pixFadeUp;">
                            Integrate your Shopify store with Logixsaas to automatically import your clients products and orders and save you valuable time.
                        </p>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="saaspik-icon-box-wrapper style-four wow pixFadeLeft" data-wow-delay="0.6s" style="visibility: visible; animation-delay: 0.6s; animation-name: pixFadeLeft;">
                        ...
                        <div class="pixsass-icon-box-content">
                            ...
                            <p>
                                You can import products directly from your clients shopify account to the system. 
                            </p>
