...
@section('title', "SMS | Twilio | Africa's talking | Logixsaas + SMS Integration")
...
@section('og:title',"SMS | Twilio | Africa's talking | Logixsaas + SMS Integration")
...
@section('twitter:title',"SMS | Twilio | Africa's talking | Logixsaas + SMS Integration")
                ...
                <div class="col-lg-7">
                    <div class="about-content">
                        ...
                        <p class="description wow pixFadeUp" data-wow-delay="0.4s" style="visibility: visible; animation-delay: 0.4s; animation-name: pixFadeUp;">
                            SMS is one of the fastest ways to keep your customers informed about their order statues. with Logixsaas, you can configure one of the following options to send SMS:
                            <ul style="list-style: circle;">
                                <li>Buy SMS credits from Logixsaas (Recommended)</li>
                                <li>Integrate with Twilio, a third party SMS service provider</li>
                                <li>Integrate with Africa's Talking, a third party SMS service provider</li>
                            </ul>
                        </p>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6">
                    <div class="saaspik-icon-box-wrapper style-four wow pixFadeLeft" data-wow-delay="0.5s" style="visibility: visible; animation-delay: 0.5s; animation-name: pixFadeLeft;">
                        <div class="saaspik-icon-box-icon">
                            <img src="{{ asset('home/sms1.png') }}" alt="" style="width: 150px; margin-top: -30px">
                        </div>
                        <hr>
                        <div class="pixsass-icon-box-content">
                            <h3 class="pixsass-icon-box-title"><a href="#">Buy Credits</a></h3>
                            <p>
                                Purchase SMS credits from Logixsaas. Each credit costs $10, and you will be able to send 1000 messages per credit.
                            </p>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="saaspik-icon-box-wrapper style-four wow pixFadeLeft" data-wow-delay="0.6s" style="visibility: visible; animation-delay: 0.6s; animation-name: pixFadeLeft;">
                        <div class="saaspik-icon-box-icon">
                            <img src="{{ asset('home/sms.png') }}" alt="" style="width: 150px; margin-top: -30px">
                        </div>
                        <hr>
                        <div class="pixsass-icon-box-content">
                            <h3 class="pixsass-icon-box-title"><a href="https://africastalking.com/" target="_blank">Africa's talking</a></h3>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="saaspik-icon-box-wrapper style-four wow pixFadeLeft" data-wow-delay="0.9s" style="visibility: visible; animation-delay: 0.9s; animation-name: pixFadeLeft;">
                        <div class="saaspik-icon-box-icon">
                            <img src="{{ asset('home/sms2.png') }}" alt="" style="width: 150px; margin-top: -30px">
                        </div>
                        <hr>
                        <div class="pixsass-icon-box-content">
                            <h3 class="pixsass-icon-box-title"><a href="www.twilio.com/referral/qXRfO7" target="_blank">Twilio</a></h3>
                            <p>
