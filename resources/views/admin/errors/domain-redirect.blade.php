        ...
        <div class="max-w-7xl mx-auto">
                        ...
                        <nav class="relative flex items-center justify-between sm:h-10 lg:justify-start"
                            ...
                            <div class="flex items-center flex-grow flex-shrink-0 lg:flex-grow-0">
                                <div class="flex items-center justify-between w-full md:w-auto">
                                    <a href="#">
                                        <span class="sr-only">Logixsaas</span>
                                        <img style="width: 170px" src="{{ asset('home/logo.png') }}">
                                    </a>
                    ...
                    <main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28"
                        ...
                        <div class="sm:text-center lg:text-left">
                            <h1 class="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                                <span class="block xl:inline">Domain </span>
                                {{-- <span class="block text-blue-600 xl:inline">{{ $domain }}</span> --}}
                            </h1>
                            <p
                                class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                                Does not exist in our database. Please enter your domain below or open a new account.</p>

                            <form method="GET" action="{{ route('domain-redirect') }}">
                                @csrf
                                ...
                                <div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                                    ...
                                    <div class="mt-3 sm:mt-0 sm:ml-3">
                                        <a href="http://{{ env('DOMAIN') }}/pricing"
            ...
            <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
                <img class="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full"
                    src="{{ asset('home/thank-you.jpg') }}" alt="">
            </div>
        </div>
    @endsection
