                                ...
                                <tr>
                                    ...
                                    <td align="right" style="text-align: left;border: none">
                                        ...
                                        <div style="">
                                            ...
                                            <address class="fs-12 text-black-50">{{ $item->client->address }}
                                            </address>
                                        </div>
                                ...
                                <tr>
                                    <td align="left">
                                        ...
                                        <img src="{{ $item->barcode }}" alt=""
                                            style="width: 180px;height: 50px;"><br>
                                    </td>
                                    <td align="right">
                                        <div style="d-block font-weight-bold; color:black">Total:
                                            <b>{{ $currency }}
