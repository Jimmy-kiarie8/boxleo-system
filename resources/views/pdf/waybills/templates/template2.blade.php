            ...
            <div class="d-flex justify-content-center row">
                <div class="col-md-10">
                    <div class="receipt bg-white p-3 rounded">
                            ...
                            <tr>
                                ...
                                <td align="center" style="border: none">
                                    <div style="text-align: left">
                                        <p class="mt-2 mb-3">Shipped From</p>
                                ...
                                <td align="right" style="text-align: left;border: none">
                                    ...
                                    <div style="">
                                        <p class="mt-2 mb-3">Ship To</p>
                                        <h4 class="fs-12 text-black-50">{{ $item->client->name }}</h4>
                                        <h4 class="fs-12 text-black-50">{{ $item->client->phone }}</h4>
                                        <address class="fs-12 text-black-50">{{ $item->client->email }}</address>
                                        <h4 class="fs-12 text-black-50">{{ $item->client->address }}</h4>
                                    </div>
                        ...
                        </span></span><span class="d-block mt-3 text-black-50 fs-15">
                        ...
                        <div class="d-flex justify-content-between align-items-center footer">
                            <div class="thanks"><span class="d-block font-weight-bold">Terms&Conditions</span>
                                <span class="" style="font-size: 16px;">
                                   <strong> {{ $company->terms }}</strong></span>
                                   <br>
