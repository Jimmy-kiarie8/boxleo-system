...
return [
     ...
     */
    'base_url' => 'https://{domain}.logixsaas.com',
    ...
    'routes' => [
        [
            ...
            'match' => [
                 ...
                 */
                'prefixes' => ['api/v1/login', 'api/v1/orders', 'api/v1/orders/store', 'api/v1/orders_store', 'api/v1/orders/{order}', 'api/v1/products',  'api/warehouse', 'api/v1/clients', 'api/ou', 'api/v1/order/{order}'],
                // 'prefixes' => ['api/*'],
    ...
    'auth' => [
         ...
         */
        'in' => 'eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9..AIC9oTfP7FUtw_RdTgLdhvPgLlgjrPKV3K2w7tee-P77wKdXDC9x5QBd75FL0GlsszGZ6R7_nMepsrRPcoL0Uh-uOJaO_A6R7o5ZJPtOYdwROPzgvnmdLzH63y_pCkuqNI0L6C4RxridhRbFs4k7XottVMc-pSRFGxmdMovsGLSOXCNRvj8NwZU_nt2HOSVGL-t-L_rDuYzBtw5G6GLPARcebECqQhXfZ97iqlbYVz0GQCiDQE7qTFWhE_Zaig6y0-QMjz0P25paLwX2L_XlWZlltEmBBPBSCnuHSSYxTCjGateEPaflbSZUJn9t3k0G7xRPqh1gaMmXdL6aTgp69jlpphgEecMcYoUCUS6jT0GeX29HviIgdryHRx3MuVR51ZOWIpKSgBirH8w6EdCgWjWA2Z9FeRubUinICD3V0rhiXbMvKqTn3hkS7ORnfaFiWOCHk88By3QB65AubhoQmfpD6j0UDecJ1CYZhkTTPOW_4455NhTXDGBh-tH2JjK1UqXLAQ0EjmqSDcMj-DLlbMnle70-PNXHUUh8_XkrAB4g5ijuyahYHfja_ZVimCSX76P2zKQwFXbNm5TGBtgCvSxzgOr4LfpFN7Lv5WH4MMCn1JUBGD1m3LIEJoSt2CbcW3unrnHcT2dBhfkMY78o_Inc2UYncFr62fimKAloG_o',
